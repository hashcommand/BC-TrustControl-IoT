...
class MobileAgent {
	...
	addDetails (frwrdingBheaviourIP,currIP,forwardingBehaviour,energy) {
		this.frwrdingIP = frwrdingBheaviourIP;
		this.CurrIP = currIP;
		this.nodeData = {
			'192.168.1.3FB' : forwardingBehaviour,
			'192.168.1.5E' : energy
		};
	...
	moveAgent () {
		...
		this.message = {"routePlan" : this.itrnRoutePlan, "192.168.1.5" : this.nodesDetails};
