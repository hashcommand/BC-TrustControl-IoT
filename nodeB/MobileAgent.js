...
class MobileAgent {
	...
	addDetails (frwrdingBheaviourIP,frwrdingBheaviour,currIP, energy) {
		this.frwrdingBheaviourIP = frwrdingBheaviourIP;
		this.currIP = currIP;
		this.nodeData = {
			'192.168.1.5FB' : frwrdingBheaviour,
			'192.168.1.4E' : energy
		};
	...
	moveAgent () {
		...
		this.message = {"route" : this.itrnRoutePlan, "192.168.1.4" : this.nodesDetails, "192.168.1.5" : this.previousData};
